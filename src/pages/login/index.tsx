...
const loginUser = async (data: any) => {
  console.log('lgoin data', await data)
  try {
    const response = await client.post('/api/loginUser', data)
...
const LoginPage = () => {
  ...
  const {
    ...
    onSuccess: data => {
      console.log('data in lgoin user', data)
      queryClient.setQueryData('LoginData', data)
      toast.success(loginData?.message?.message)
      router.push('/otp')
    },
    onError: () => {
  ...
  console.log('loginData', loginData, error)
  ...
  const onSubmitHandler = (e: any) => {
    ...
    if (!username) {
      toast.error('Please enter Email/Mobile')
    } else if (!password) {
          ...
          <form noValidate autoComplete='off' onSubmit={e => onSubmitHandler(e)}>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap', justifyContent: 'center' }}>
              ...
              <Typography variant='body2'>
                <LinkFixed passHref href='/pages/register'>
